...
BEGIN_TILING_DATA_DEF(DevicePagedKvReadTilingData)
TILING_DATA_FIELD_DEF(uint32_t, stateElements);
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(DevicePagedKvRead, DevicePagedKvReadTilingData)

struct DevicePagedKvReadCompileInfo {};
...
static ge::graphStatus TilingFunc(gert::TilingContext *context) {
  ...
  DevicePagedKvReadTilingData tiling;
...
IMPL_OP_OPTILING(DevicePagedKvRead)
    .Tiling(TilingFunc)
    .TilingParse<DevicePagedKvReadCompileInfo>(TilingParseFunc);
