...
def eager_screen(
    ...
    with torch.no_grad():
        for step, token_id in enumerate(token_ids, start=1):
            ...
            component_bits = {
                "probabilities": bf16_bits(last_probabilities)[..., :step],
    ...
    reference_path = output_dir / "attempt53i-eager-reference.npz"
    np.savez(reference_path, **reference)
    result = {
        "gate": "G4a Attempt 53i layer-27 component localization",
