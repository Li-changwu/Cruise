# G4a Attempt 53i: Layer-27 Component Localization

Date frozen: 2026-07-23

## Claim

This diagnostic experiment locates the first component inside layer 27 that
differs between Hugging Face eager and the fixed-capacity Paged-KV decoder.
...
- Hooks observe softmax probabilities, O-projection output, attention residual
  output and MLP output; the manual path returns the same tensors.
