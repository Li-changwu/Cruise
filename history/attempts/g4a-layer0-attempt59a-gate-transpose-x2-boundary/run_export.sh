...
src=${root}/attempt59a-src
raw=${root}/raw-attempt59a-export
export_dir=${root}/export-attempt59a
cache=${root}/cache-attempt59a-export
...
python "${src}/compare_eager.py" --baseline "${baseline_reference}" \
  --candidate "${export_dir}/attempt59a-eager-reference.npz" \
...
sha256sum "${export_dir}/qwen_layer0_boundary_attempt59a.air" \
  "${export_dir}/dynamo.pbtxt" "${export_dir}/attempt59a-eager-reference.npz" \
