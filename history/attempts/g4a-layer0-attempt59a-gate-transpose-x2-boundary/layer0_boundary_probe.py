...
class Layer0BoundaryProbe(torch.nn.Module):
    ...
    def forward(
        ...
        gate_preactivation = torch.ops.g4a_materialize.materialize(
            torch.ops.g4a_matmulv2_t.mm_t(gate_input, self.gate_weight).reshape(
...
def register_custom_ops(
    ...
    import gate_matmulv2_transpose_x2  # noqa: F401
...
def main() -> None:
    ...
    reference_path = args.output_dir / "attempt59a-eager-reference.npz"
    ...
    dynamo_export(
        ...
        export_name="qwen_layer0_boundary_attempt59a",
        dynamic=False,
        config=config,
    )
    air = args.output_dir / "qwen_layer0_boundary_attempt59a.air"
