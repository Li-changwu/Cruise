# G4b Attempt 66b-r3: B=1 device-resident real generation epoch
...
`DT_UNDEFINED`. Attempt 66b-r3 changes only the two GraphPp JSON descriptors
from `DT_BF16` to GE's printed spelling `DT_BFLOAT16`, plus experiment-isolated
paths and identifiers. Graph, control, input, tolerance and comparison
