# G4a Attempt 53h: Complete-Decoder Per-Layer Localization

Date frozen: 2026-07-23

## Claim

This diagnostic experiment locates the first decoder layer whose hidden state
differs between Hugging Face eager and the manual Paged-KV decoder at step 4.
...
- Forward hooks and a stacked per-layer hidden output are diagnostic only.
