...
src=${root}/attempt60a-src
eager=${root}/raw-attempt60a-eager
raw=${root}/raw-attempt60a-export
export_dir=${root}/export-attempt60a
cache=${root}/cache-attempt60a-export
