# G4c Attempt 69e-r4: B=4 Device-Resident Generation Epoch

Date frozen: 2026-07-26

Attempt 69e-r4 preserves the 69e model, controller, cases, comparison
semantics, and r3 preparation reuse. It performs the expensive persistent-tree
audit before waiting up to one hour for NPU 7. While waiting it creates no
evidence or scratch target, monitors filesystem reserves, and repeats the full
storage audit every five minutes. Once NPU 7 is idle, it acquires the guard
lock, rechecks the device, commits the fresh directories, and immediately
copies the successful r2 preparation. Attempt 69e-r3 was rejected before
directory creation because another container reclaimed NPU 7 during its
storage audit.
