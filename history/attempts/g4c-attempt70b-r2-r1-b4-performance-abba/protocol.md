# G4c Attempt 70b-r2-r1: B=4 Blocked-ABBA Resident-Epoch Performance

Date frozen: 2026-07-26

Attempt 70b-r2-r1 preserves the accepted 69e-r5 AIR, Device UDF, inputs,
...
This revision changes only Graph ownership and teardown ordering: Session is
released first, the explicitly owned Graph second, and GE is finalized last.
...
produced no performance sample. This resource-only retry keeps the r2 host
runner byte-identical and extends each NPU-ready wait to 21600 seconds. Waiting
duration remains outside all measured intervals.
...
- Every block launch and the final state require an empty NPU process list plus
  HBM usage at or below 5% for three consecutive five-second samples.
