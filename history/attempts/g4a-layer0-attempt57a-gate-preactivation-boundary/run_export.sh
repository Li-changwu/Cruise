...
src=${root}/attempt57a-src
raw=${root}/raw-attempt57a-export
export_dir=${root}/export-attempt57a
cache=${root}/cache-attempt57a-export
...
sha256sum "${export_dir}/qwen_layer0_boundary_attempt57a.air" \
  "${export_dir}/dynamo.pbtxt" "${export_dir}/attempt57a-eager-reference.npz" \
