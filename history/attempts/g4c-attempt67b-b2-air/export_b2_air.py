...
def main() -> None:
    ...
    dynamo_export(
        ...
        export_name="qwen_b2_decoder_step_attempt67b",
        dynamic=False,
        config=config,
    )
    air = args.output_dir / "qwen_b2_decoder_step_attempt67b.air"
    ...
    result = {
        "gate": "G4c Attempt 67b B=2 decoder AIR export",
    ...
    print("G4C_ATTEMPT67B_EXPORT " + json.dumps(result, ensure_ascii=True), flush=True)
