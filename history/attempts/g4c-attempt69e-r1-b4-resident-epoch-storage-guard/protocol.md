# G4c Attempt 69e-r1: B=4 Device-Resident Generation Epoch

Date frozen: 2026-07-26

Attempt 69e-r1 preserves the 69e model, controller, cases, and comparison
semantics. The revision changes only experiment storage and log lifecycle.
