# G4b Attempt 66a-r6-r2: BF16 Host-to-Device-UDF echo
...
Attempt 66a-r6 removed the decoder AIR and GraphPp, but failed before compiling
the UDF because its relative workspace was resolved from the process working
directory. Attempt 66a-r6-r2 changes only that workspace to the absolute fresh
source path. The Device UDF validates a 16-element BF16 tensor and returns the
same FlowMsg.
