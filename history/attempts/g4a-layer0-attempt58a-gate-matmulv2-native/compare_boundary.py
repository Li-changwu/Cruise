...
def main() -> None:
    ...
    if not common_eager_references_exact or not native_prefix_exact:
        ...
        mechanism_result = "matmulv2_not_exact"
    elif not step1_gate_exact:
        mechanism_result = "silu_not_exact"
    else:
        mechanism_result = "gate_path_exact"
    ...
    diagnostic_valid = (
        ...
        and mechanism_result == "gate_path_exact"
    )
    result = {
        "gate": "Attempt 58a gate MatMulV2 single-variable probe",
        ...
        "steps": steps,
        "claim_boundary": (
            "Layer-0 gate MatMulV2 lowering only; this cannot pass complete G4a."
        ),
    }
