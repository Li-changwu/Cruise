# G4c Attempt 70a-r1: B=4 Device Fallback Recovery

Date frozen: 2026-07-26

Attempt 70a reached `FeedDataFlowGraph` but failed before any recovery case
with device HBM OOM. Its preflight observed no process immediately after an
external job exited, which was insufficient to establish memory readiness.
Attempt 70a-r1 additionally requires HBM usage at or below 5% for three
consecutive five-second samples before graph loading.
