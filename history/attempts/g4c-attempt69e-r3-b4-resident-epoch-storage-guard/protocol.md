# G4c Attempt 69e-r3: B=4 Device-Resident Generation Epoch

Date frozen: 2026-07-26

Attempt 69e-r3 preserves the 69e model, controller, cases, comparison
semantics, and r2 storage guard. It may copy the successful r2 inputs and Host
binary inside `/dev/shm` after checking the r2 status and identical Host build
sources. This removes a six-minute compilation window in which another
container reclaimed NPU 7. If the prepared scratch is unavailable, r3 rebuilds
from the frozen source. Attempt 69e-r2 built successfully but stopped at the
pre-Host idle check before either execution route was launched.
