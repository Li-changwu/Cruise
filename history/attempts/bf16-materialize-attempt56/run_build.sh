...
src=${g4}/attempt56-materialize-src
base=${g2g}/custom-op-project
project=${g4}/custom-op-project-attempt56
op=${project}/bf16_materialize
raw=${g4}/raw-attempt56-materialize-build
install=${g4}/install-attempt56
...
sha256sum "${src}"/* "${op}/op_kernel/bf16_materialize.cpp" "${op}/op_host"/* \
