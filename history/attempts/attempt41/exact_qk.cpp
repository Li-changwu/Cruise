...
public:
                                          ...
                                          __gm__ uint8_t *__restrict__ c, __gm__ uint8_t *__restrict__ tiling_data)
    {
        ...
        // ExactQk has one fixed shape; static tiling avoids GE's invalid fifth pointer.
        batch_size = 28;
        m = 1;
        k = 128;
        n = 8;
...
extern "C" __global__ __aicore__ void exact_qk(GM_ADDR gm_a, GM_ADDR gm_b, GM_ADDR gm_c,
