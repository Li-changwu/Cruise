...
NAMES = (
    ...
    "masked_scores_bf16", "probabilities_bf16", "attention_value_bf16",
    "attention_flat_bf16", "attention_output_bf16",
)
FROZEN_NAMES = NAMES[:16]
PRIMARY_EXACT = (
...
SHAPES = {
    ...
    "masked_scores_bf16": (1, 28, 1, 8),
    "probabilities_bf16": (1, 28, 1, 8),
    "attention_value_bf16": (1, 28, 1, 128),
    "attention_flat_bf16": (1, 1, 3584),
    "attention_output_bf16": (1, 1, 3584),
}
...
def main() -> None:
    ...
    result = {
        "gate": "G4a Attempt 52f Attention boundary localization",
