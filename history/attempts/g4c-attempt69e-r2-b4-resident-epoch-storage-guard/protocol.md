# G4c Attempt 69e-r2: B=4 Device-Resident Generation Epoch

Date frozen: 2026-07-26

Attempt 69e-r2 preserves the 69e model, controller, cases, and comparison
semantics. It keeps the r1 storage and log lifecycle and fixes the `set -u`
safe construction of the pre-Host NPU-state output path. Attempt 69e-r1
stopped after a successful build before either execution route was launched.
