...
src=${root}/attempt66a-r6-src
raw=${root}/raw-attempt66a-r6-bf16-udf-echo
cache=${root}/cache-attempt66a-r6-bf16-udf-echo
build=${root}/build-attempt66a-r6-bf16-udf-echo
