...
EXPECTED_OUTPUTS = (
    ...
    ("DT_BF16", (28, 1, 1, 3584), "layer_hiddens"),
    ("DT_BF16", (1, 1, 3584), "layer0_input_norm"),
    ("DT_BF16", (1, 28, 1, 128), "layer0_query_rope"),
    ("DT_BF16", (1, 4, 1, 128), "layer0_key_rope"),
    ("DT_BF16", (1, 4, 1, 128), "layer0_value_projection"),
    ("DT_BF16", (1, 28, 1, 8), "layer0_masked_scores"),
    ("DT_BF16", (1, 28, 1, 8), "layer0_probabilities"),
    ("DT_BF16", (1, 28, 1, 128), "layer0_attention_value"),
    ("DT_BF16", (1, 1, 3584), "layer0_attention_projection"),
    ("DT_BF16", (1, 1, 3584), "layer0_hidden_after_attention"),
    ("DT_BF16", (1, 1, 3584), "layer0_post_attention_norm"),
    ("DT_BF16", (1, 1, 18944), "layer0_gate_preactivation"),
    ("DT_BF16", (1, 1, 18944), "layer0_gate"),
    ("DT_BF16", (1, 1, 18944), "layer0_up"),
    ("DT_BF16", (1, 1, 18944), "layer0_mlp_product"),
    ("DT_BF16", (1, 1, 3584), "layer0_mlp_projection"),
    ("DT_BF16", (1, 1, 3584), "layer0_hidden_after_mlp"),
)
