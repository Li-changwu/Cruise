...
BLOCK_SIZE = 128
BLOCK_TABLE = np.asarray([[1, 0], [3, 2]], dtype=np.int32)
CASES = (
    ("k1-heterogeneous", 1, "case0", [0, 2], [1, 1]),
    ("k2-heterogeneous", 2, "case0", [0, 2], [1, 1]),
    ("k4-heterogeneous", 4, "case0", [0, 2], [1, 1]),
    ("k8-both-active", 8, "case0", [0, 0], [1, 1]),
    ("active-empty", 4, "case1", [1, 0], [1, 0]),
    ("finished-active", 4, "case2", [3, 1], [0, 1]),
    ("independent-early-eos", 4, "case0", [0, 2], [1, 1]),
)
