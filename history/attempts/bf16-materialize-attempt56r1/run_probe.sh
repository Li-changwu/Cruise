...
src=${root}/attempt56r1-materialize-src
export_dir=${root}/export-attempt56r1-materialize
raw=${root}/raw-attempt56r1-materialize-probe
cache=${root}/cache-attempt56r1-materialize-probe
...
sha256sum "${src}/CMakeLists.txt" "${src}"/*.cpp "${src}"/*.py "${src}"/*.sh \
  "${src}"/*.md >"${raw}/input-integrity.log"
