...
def main() -> None:
    ...
    result = {
        "gate": "G4a Attempt 65 clean residual-defused decoder recurrence",
        ...
        "steps": steps,
        "claim_boundary": (
            "Passing closes clean G4a for B=1 complete decoder recurrence; device-side "
            "sampling, EOS and resident epoch control remain G4b."
        ),
    }
