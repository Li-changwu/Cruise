...
class Layer0BoundaryProbe(torch.nn.Module):
    ...
    def forward(
        ...
        gate = F.silu(F.linear(post_attention_norm, self.gate_weight))
...
def main() -> None:
    ...
    register_custom_ops(args.exact_qk_source, args.barrier_source)
    ...
    reference_path = args.output_dir / "attempt55a-eager-reference.npz"
    ...
    dynamo_export(
        ...
        export_name="qwen_layer0_boundary_attempt55a",
        dynamic=False,
        config=config,
    )
    air = args.output_dir / "qwen_layer0_boundary_attempt55a.air"
