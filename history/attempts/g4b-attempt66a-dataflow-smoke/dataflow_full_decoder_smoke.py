...
def enable_bf16_numpy_bridge() -> None:
    """Fill the BF16 mapping omitted by the CANN 9.0 NumPy DataFlow wrapper."""
...
def main() -> None:
    ...
    result = {
        "gate": "G4b Attempt 66a DataFlow full-decoder BF16 smoke",
        "pass": False,
        ...
        "bf16_bridge": "process-local CANN 9.0 NumPy dtype registration",
        "claim_boundary": (
