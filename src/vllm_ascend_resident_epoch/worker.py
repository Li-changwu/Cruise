...
from .backend import NativeWarmupOutput, ResidentEpochBackend, load_backend_from_env
...
class ResidentEpochWorker(WorkerBase):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.warmup_output: NativeWarmupOutput | None = None
    ...
    def compile_or_warm_up_model(self) -> CompilationTimes:
        ...
        self.warmup_output = self.backend.warm_up()
        return CompilationTimes(
            language_model=self.warmup_output.wall_us / 1_000_000,
            encoder=0.0,
        )
